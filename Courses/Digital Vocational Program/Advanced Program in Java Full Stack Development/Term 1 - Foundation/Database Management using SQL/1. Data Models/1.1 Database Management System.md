A  *database* is a collection of logically related data. Data means known facts, which are meaningful and can be recorded. For example, names, telephones, and addresses.
